...
With Npc(MapNpc(MapNpcNum).num)
    ...
    TextY = MapNpc(MapNpcNum).Y * PIC_Y + MapNpc(MapNpcNum).YOffset - CLng(PIC_Y / 2) - 4
                                ...
                                If y1 + y2 <= MAX_MAPY Then
                                    If frmDualSolace.optLayers.Value = True Then
                                          With Map.Tile(x1 + x2, y1 + y2)
                                              If frmDualSolace.optGround.Value = True Then .Ground = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optMask.Value = True Then .Mask = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optMask2.Value = True Then .Mask2 = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optAnim.Value = True Then .Anim = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optAnim2.Value = True Then .Anim2 = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optFringe.Value = True Then .Fringe = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optFringeAnim.Value = True Then .FringeAnim = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                              If frmDualSolace.optFringe2.Value = True Then .Fringe2 = (EditorTileY + y2) * 7 + (EditorTileX + x2)
                                          End With
                                    End If
                                End If
                            End If
