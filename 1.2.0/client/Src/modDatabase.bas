...
' Set Status Label
.lblStatus.Left = CLng(GetVar(App.Path & GUI_PATH & "config.ini", "Information Window", "LabelStatusX"))
.lblStatus.top = CLng(GetVar(App.Path & GUI_PATH & "config.ini", "Information Window", "LabelStatusY"))
