...
Dim WeaponDur As Long, ArmorDur As Long, HelmetDur As Long, ShieldDur As Long
    ...
    If LCase(Parse(0)) = "newcharclasses" Then
        ...
        frmNewChar.lblHP.Caption = STRING_HP + ": " + STR(Class(0).HP)
        frmNewChar.lblMP.Caption = STRING_MP + ": " + STR(Class(0).MP)
        frmNewChar.lblSP.Caption = STRING_SP + ": " + STR(Class(0).SP)
    
        frmNewChar.lblSTR.Caption = STRING_STRENGTH + ": " + STR(Class(0).STR)
        frmNewChar.lblDEF.Caption = STRING_DEFENSE + ": " + STR(Class(0).DEF)
        frmNewChar.lblSPEED.Caption = STRING_SPEED + ": " + STR(Class(0).Speed)
        frmNewChar.lblMAGI.Caption = STRING_MAGIC + ": " + STR(Class(0).MAGI)
    ...
    If LCase(Parse(0)) = "ingame" Then
        ...
        frmMainMenu.tmrIntroMusic.Enabled = False
        Call GameLoop
    ...
    If LCase(Parse(0)) = "playerstats" Then
        ...
        frmDualSolace.lblSTR.Caption = STRING_STRENGTH + ": " + STR(Parse(1))
        frmDualSolace.lblDEF.Caption = STRING_DEFENSE + ": " + STR(Parse(2))
        frmDualSolace.lblSpd.Caption = STRING_SPEED + ": " + STR(Parse(3))
        frmDualSolace.lblMAGI.Caption = STRING_MAGIC + ": " + STR(Parse(4))
    ...
    If LCase(Parse(0)) = "playerplayers" Then
        ...
        frmDualSolace.lblPNumber.Caption = UBound(Parse) - 1
    ...
    If LCase(Parse(0)) = "playerfriends" Then
        ...
        For n = 1 To UBound(Parse)
            ...
            If IsPlaying(FindPlayer(Parse(n))) And Parse(n) <> vbNullString Then
                frmDualSolace.lstFriends.AddItem Parse(n)
                i = i + 1
            End If
        Next n
        
        frmDualSolace.lblFNumber.Caption = i
    ...
    If LCase(Parse(0)) = "mapdone" Then
        ...
        If Map.Music <> "No Music" And Map.Music <> "" Then
            ...
            If frmGameSettings.chkMusic.Value = 1 Then
                If UCase$(Right$(Map.Music, 3)) = "MID" Then
                    Call DirectMusic.PlayMusic(Map.Music)
                ElseIf UCase$(Right$(Map.Music, 3)) = "MP3" Then
                    ...
                    'Play the mp3
                    Call DirectShow.PlayMP3
                    frmDualSolace.tmrMP3.Enabled = True
                End If
            End If
        End If
        Exit Sub
    ...
    If (LCase(Parse(0)) = "updatenpc") Then
        ...
        Npc(n).Speed = 0
        Npc(n).MAGI = 0
        Npc(n).TintR = Val(Parse(4))
        Npc(n).TintG = Val(Parse(5))
        Npc(n).TintB = Val(Parse(6))
    ...
    If (LCase(Parse(0)) = "trade") Then
        ...
        End If
            ...
            '    frmTrade.lblCost.Caption = "(Costs " + CStr(Shop(ShopNum).TradeItem(1).GiveValue) + " " + Trim$(Item(Shop(ShopNum).TradeItem(1).GiveItem).Name) & ")"
            'End If
            '    frmTrade.lblStock.Caption = CStr(Shop(ShopNum).TradeItem(1).Stock) + " in Stock."
    ...
    If (LCase(Parse(0)) = "tradegetitem") Then
        ...
        frmTrade.lblCost.Caption = "(Costs " + Parse(5) + " " + Trim$(Parse(4)) + ")"
        
        If Val(Parse(6)) = -1 Then
            frmTrade.lblStock.Caption = "Inifinite in Stock."
        Else
            frmTrade.lblStock.Caption = Parse(6) + " in Stock."
        End If
        ...
        'Set high labels
        frmTrade.lblHSTR.Caption = STRING_STRENGTH + ": " + CStr(GetPlayerSTR(MyIndex))
        frmTrade.lblHDEF.Caption = STRING_DEFENSE + ": " + CStr(GetPlayerDEF(MyIndex))
        frmTrade.lblHMAG.Caption = STRING_MAGIC + ": " + CStr(GetPlayerMAGI(MyIndex))
        frmTrade.lblHSPD.Caption = STRING_SPEED + ": " + CStr(GetPlayerSPEED(MyIndex))
        
        'Set the original labal colors for the new stats
        frmTrade.lblHSTR.ForeColor = &HFFFFFF
        frmTrade.lblHDEF.ForeColor = &HFFFFFF
        frmTrade.lblHMAG.ForeColor = &HFFFFFF
        frmTrade.lblHSPD.ForeColor = &HFFFFFF
        ...
        If CInt(Parse(7)) = 1 Then
            If CLng(Parse(8)) > Weapon Then
                ...
                frmTrade.lblHSTR.Caption = frmTrade.lblHSTR.Caption + " + " + CStr(CLng(Parse(8)))
        ...
        ElseIf CInt(Parse(7)) = 2 Then
            If CLng(Parse(8)) > Armor Then
                ...
                frmTrade.lblHDEF.Caption = frmTrade.lblHDEF.Caption + " + " + CStr(CLng(Parse(8)))
    ...
    If (LCase(Parse(0)) = "pstats") Then
        frmDualSolace.lblSTR.Caption = STRING_STRENGTH + ": " + Val(Parse(1))
        frmDualSolace.lblDEF.Caption = STRING_DEFENSE + ": " + Val(Parse(2))
        frmDualSolace.lblMAGI.Caption = STRING_MAGIC + ": " + Val(Parse(3))
        frmDualSolace.lblSpd.Caption = STRING_SPEED + ": " + Val(Parse(4))
        frmDualSolace.lblPName.Caption = Parse(5)
        frmDualSolace.lblLevel.Caption = Val(Parse(6))
        frmDualSolace.lblEXP.Caption = Val(Parse(7))
        frmDualSolace.lblTNL.Caption = Val(Parse(8))
    ...
    If (LCase(Parse(0)) = "playerleave") Then
        n = Parse(1)
        f = Val(frmDualSolace.lblPNumber.Caption)
        
        frmDualSolace.lblPNumber.Caption = f - 1
    ...
    ' :::::::::::::::::::::::::::::::
    If LCase(Parse(0)) = "strings" Then
        ' Set stat names
        STRING_STRENGTH = Parse(1)
        STRING_DEFENSE = Parse(2)
        STRING_MAGIC = Parse(3)
        STRING_SPEED = Parse(4)
        STRING_HP = Parse(5)
        STRING_MP = Parse(6)
        STRING_SP = Parse(7)
