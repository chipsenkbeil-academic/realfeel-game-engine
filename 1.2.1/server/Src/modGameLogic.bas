...
Dim ArmorSlot As Long, HelmSlot As Long
    ...
    GetPlayerProtection = Int(GetPlayerDEF(Index) / 4)
    ...
    If Damage >= MapNpc(MapNum, Victim).HP Then
        ...
        For i = 0 To frmLibrary.lstLibrary.ListCount - 1
            ...
            If GetVar(FileName, "DATA", "Enabled") = "True" Then
                MyScript.ExecuteStatement frmLibrary.lstLibrary.List(i), "NpcDeath " & MapNpcNum & "," & Victim & "," & MapNpcNum & "," & MapNum & "," & False
            End If
        Next i
...
Dim STR As Long, DEF As Long, MapNum As Long, NpcNum As Long
    ...
    If Damage >= MapNpc(MapNum, MapNpcNum).HP Then
        ...
        For i = 0 To frmLibrary.lstLibrary.ListCount - 1
            FileName = App.Path & "\Library\" & frmLibrary.lstLibrary.List(i)
            If GetVar(FileName, "DATA", "Enabled") = "True" Then
                MyScript.ExecuteStatement frmLibrary.lstLibrary.List(i), "NpcDeath " & Attacker & "," & NpcNum & "," & MapNpcNum & "," & MapNum & "," & True
            End If
        Next i
...
Dim FileName As String
    ...
    Call PlayerMsg(Index, "Welcome to " & GAME_NAME & ", Created with the RealFeel engine! www.DualSolace.com ", White)
    'Run Scripts
    For i = 0 To frmLibrary.lstLibrary.ListCount - 1
        FileName = App.Path & "\Library\" & frmLibrary.lstLibrary.List(i)
        If GetVar(FileName, "DATA", "Enabled") = "True" Then
            MyScript.ExecuteStatement frmLibrary.lstLibrary.List(i), "JoinGame " & Index
        End If
    Next i
...
Dim p As Integer
    ...
    If Player(Index).InGame = True Then
        ...
        For i = 0 To frmLibrary.lstLibrary.ListCount - 1
            FileName = App.Path & "\Library\" & frmLibrary.lstLibrary.List(i)
            If GetVar(FileName, "DATA", "Enabled") = "True" Then
                MyScript.ExecuteStatement frmLibrary.lstLibrary.List(i), "LeaveGame " & Index
            End If
        Next i
